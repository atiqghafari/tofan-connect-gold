  ...
  return (
    <>
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-[oklch(0.42_0.06_74_/_55%)] via-[oklch(0.30_0.04_72_/_25%)] to-transparent mix-blend-soft-light" />
